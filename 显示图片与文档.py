# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 19:31:38 2019
...
class filedialogdemo(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("显示电脑上图片与文档")

        self.setLayout(layout)

    def loadFile(self):
        print("load--file")
        fname, _ = QFileDialog.getOpenFileName(self, '选择图片', 'C:\\Users\\YahuiLEE', 'Image files(*.jpg *.gif *.png)')
